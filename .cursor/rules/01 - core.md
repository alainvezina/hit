...
- Follow all domain and interaction rules defined in this document.
- Apply **Tony Rules** (`07 - tony.md`) at all times to minimize token and compute cost.
- The agent must treat every reasoning step as a billable resource.
- When in doubt, prioritize accuracy → brevity → cost.

> See: [Token Economy Awareness — 07 - tony.md](./07%20-%20tony.md)
